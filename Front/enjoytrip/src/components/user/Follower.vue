...
const { follower } = storeToRefs(followStore);
...
<template>
    <h2 class="text-center mt-4">팔로워 목록</h2>
    <ul role="list" class="divide-y w-2/5 mx-auto">
        <li v-for="person in follower" :key="person.Id" class="flex justify-between gap-x-6 py-5">
