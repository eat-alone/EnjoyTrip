<template>
  <ul role="list" class="mx-auto divide-y hover:divide-solid divide-gray-400 w-3/4">
    <div class="flex justify-between">
      <button
        @click="moveWrite"
        class="mt-10 flex w-18 items-center justify-center rounded-md border bg-indigo-500 px-1 py-2 text-base text-sm text-white hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2"
      >
        글쓰기
      </button>
