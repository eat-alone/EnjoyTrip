...
//	//http://localhost/vue/swagger-ui/index.html
    ...
    public Docket userApi() {
        return new Docket(DocumentationType.OAS_30)
            ...
            .apiInfo(userApiInfo())
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.ssafy.enjoytrip.member.controller"))
            .paths(PathSelectors.ant("/enjoytrip/user/**"))
            .build()
            .useDefaultResponseMessages(false);
    }
    ...
    public Docket boardApi() {
        return new Docket(DocumentationType.OAS_30)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.ssafy.enjoytrip.board.controller"))
            .paths(PathSelectors.ant("/enjoytrip/board/**"))
            .build()
            .useDefaultResponseMessages(false);
    }
    ...
    public Docket mapApi() {
        return new Docket(DocumentationType.OAS_30)
            ...
            .apiInfo(mapApiInfo())
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.ssafy.enjoytrip.map.controller"))
            .paths(PathSelectors.ant("/enjoytrip/map/**"))
            .build()
            .useDefaultResponseMessages(false);
    }
